...
A chord chart is just text. Songs move through chords in patterns so conventional that musicians name them like grammar. Establish the home chord, build tension, resolve it home. Gospel and jazz players decorate that skeleton in predictable ways every time, and soul lives in performance and subtle surprises. Bass lines climb stepwise into the next chord, a "secondary dominant" appears as a "home away from home," and the "amen" cadence you hear at the end of a hymn closes the tune.

An LLM has read a million chord charts, and predicting the next chord in a progression is the same thing it does with words all day. Asking it to gospel-ify a three-chord song produces an autocomplete based on a century of gospel piano. The results mostly held up at the piano. Here's the intro to "If I Had a Hammer," before and after:
